...
class _ChatPageState extends State<ChatPage> {
  ...
  _checkinChat() async {
    ...
    if (_participants.contains(widget.userName))
      inChat = true;
    else
      inChat = false;
  }
  ...
  _checkMuted() async {
    ...
    _muted.forEach((element) {
      element.toLowerCase();
    });
    if (_muted.contains(widget.userName))
      muted = true;
    else
      muted = false;
  }
        ...
        leading: Builder(
          builder: (BuildContext context) {
            return IconButton(
                ...
                onPressed: () {
                  DatabaseMethods()
                      .updateChatInfo(widget.groupId, widget.userName, false);
  ...
  void _popup(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text(
        'You\'ve been muted by this chat\'s administrator!',
